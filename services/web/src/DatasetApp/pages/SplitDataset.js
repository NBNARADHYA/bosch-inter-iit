...
function SplitDataset(props) {
  ...
  const afterLoaded = Boolean(
    afterCountData.train_x.length && afterCountData.val_x.length
  );
    ...
    <>
      ...
      >
        ...
        >
          ...
          This tool assists you to split the dataset into train and test sets.A
          ...
          a fast and easy procedure to perform, the results of which allow you
          to compare the performance of machine learning algorithms for your
