const augmentations = [
  {
    ...
    parameters: '[{"name":"blur_limit","type":"int, [int, int]","description":"maximum kernel size for blurring the input image. Should be in range [3, inf). Default: (3, 7).","default":7},{"name":"p","type":"float","description":"probability of applying the transform. Default: 0.5.","default":0.5}]',
    category: 0
  },
  {
    id: 2,
    ...
    parameters: '[{"name":"channel_drop_range","type":"[int, int]","description":"range from which we choose the number of channels to drop.","default":"(1,1)"},{"name":"fill_value","type":"int, float","description":"pixel value for the dropped channel.","default":0},{"name":"p","type":"float","description":"probability of applying the transform. Default: 0.5.","default":0.5}]',
    category: 0
  },
  {
    id: 3,
    ...
    parameters: '[{"name":"p","type":"float","description":"probability of applying the transform. ","default":0.5}]',
    category: 0
  },
  {
    id: 4,
  ...
  },
  {
    ...
    parameters: '[{"name":"scale_min","type":"float","description":"lower bound on the image scale. Should be < 1.","default":0.25},{"name":"scale_max","type":"float","description":"lower bound on the image scale. Should be .","default":0.25},{"name":"interpolation","type":null,"description":"cv2 interpolation method. cv2.INTER_NEAREST by default","default":0}]',
    category: 0
  },
  {
    id: 9,
  ...
  },
  {
    ...
    parameters: '[{"name":"alpha","type":"float","description":"how much to perturb/scale the eigen vecs and vals. scale is samples from gaussian distribution (mu=0, sigma=alpha)","default":0.1}]',
    category: 0
  },
  {
    id: 12,
  ...
  },
  {
    id: 13,
    name: 'FromFloat',
    description: 'Take an input array where all values should lie in the range [0, 1.0], multiply them by max_value and then cast the resulted value to a type specified by dtype. If max_value is None the transform will try to infer the maximum value for the data type from the dtype argument.',
    parameters: `[{"name":"max_value","type":"float","description":"maximum possible input value. Default: None.","default":"None"},{"name":"dtype","type":"string or numpy data type","description":"data type of the output. See the 'Data types' page from the NumPy docs_. Default: 'uint16'.","default":"'uint16'"},{"name":"p","type":"float","description":"probability of applying the transform. Default: 1.0.","default":1}]`,
    category: 0
  },
  {
    id: 14,
  ...
  },
  {
    ...
    parameters: '[{"name":"quality_lower","type":"float","description":"lower bound on the image quality. Should be in [0, 100] range for jpeg and [1, 100] for webp.","default":99},{"name":"quality_upper","type":"float","description":"upper bound on the image quality. Should be in [0, 100] range for jpeg and [1, 100] for webp.","default":100},{"name":"compression_type","type":"ImageCompressionType","description":"should be ImageCompressionType.JPEG or ImageCompressionType.WEBP. Default: ImageCompressionType.JPEG","default":"<ImageCompressionType.JPEG: 0>"}]',
    category: 0
  },
  {
    id: 22,
  ...
  },
  {
    ...
    parameters: '[{"name":"quality_lower","type":"float","description":"lower bound on the jpeg quality. Should be in [0, 100] range","default":99},{"name":"quality_upper","type":"float","description":"upper bound on the jpeg quality. Should be in [0, 100] range","default":100}]',
    category: 0
  },
  {
    id: 25,
    name: 'Lambda',
    description: 'A flexible transformation class for using user-defined transformation functions per targets. Function signature must include **kwargs to accept optinal arguments like interpolation method, image size, etc:',
    parameters: '[{"name":"image","type":"callable","description":"Image transformation function.","default":"None"},{"name":"mask","type":"callable","description":"Mask transformation function.","default":"None"},{"name":"keypoint","type":"callable","description":"Keypoint transformation function.","default":"None"},{"name":"bbox","type":"callable","description":"BBox transformation function.","default":"None"},{"name":"always_apply","type":"bool","description":"Indicates whether this transformation should be always applied.","default":"False"},{"name":"p","type":"float","description":"probability of applying the transform. Default: 1.0.","default":1}]',
    category: 0
  },
  {
    id: 26,
    name: 'MaskDropout',
    description: 'Image & mask augmentation that zero out mask and image regions corresponding to randomly chosen object instance from mask.',
  ...
  },
  {
    ...
    parameters: '[{"name":"blur_limit","type":"int","description":"maximum aperture linear size for blurring the input image. Must be odd and in range [3, inf). Default: (3, 7).","default":7},{"name":"p","type":"float","description":"probability of applying the transform. Default: 0.5.","default":0.5}]',
    category: 0
  },
  {
    id: 28,
    ...
    parameters: '[{"name":"blur_limit","type":"int","description":"maximum kernel size for blurring the input image. Should be in range [3, inf). ","default":"(3, 7)"},{"name":"p","type":"float","description":"probability of applying the transform. ","default":0.5}]',
    category: 0
  },
  {
    id: 29,
  ...
  },
  {
    ...
    parameters: '[{"name":"mean","type":"float, list of float","description":"mean values","default":"(0.485,0.456,0.406)"},{"name":"std","type":"(float, list of float","description":"std values","default":"(0.229,0.224,0.225)"},{"name":"max_pixel_value","type":"float","description":"maximum possible pixel value","default":255}]',
    category: 0
  },
  {
    id: 31,
  ...
  },
  {
    ...
    parameters: '[{"name":"limit","type":"[float, float] or float","description":"factor range for changing brightness. If limit is a single float, the range will be (-limit, limit). Default: (-0.2, 0.2).","default":0.2},{"name":"p","type":"float","description":"probability of applying the transform. Default: 0.5.","default":0.5}]',
    category: 0
  },
  {
    id: 35,
  ...
  },
  {
    ...
    parameters: '[{"name":"limit","type":"[float, float] or float","description":"factor range for changing contrast. If limit is a single float, the range will be (-limit, limit). Default: (-0.2, 0.2).","default":0.2},{"name":"p","type":"float","description":"probability of applying the transform. Default: 0.5.","default":0.5}]',
    category: 0
  },
  {
    id: 37,
  ...
  },
  {
    ...
    name: 'RandomGamma',
    description: null,
    parameters: '[{"name":"gamma_limit","type":"float or [float, float]","description":"If gamma_limit is a single float value, the range will be (-gamma_limit, gamma_limit). Default: (80, 120).","default":"(80,120)"},{"name":"eps","type":null,"description":"Deprecated.","default":"None"}]',
    category: 0
  },
  {
    id: 39,
    ...
    parameters: '[{"name":"grid","type":"[int, int]","description":"size of grid for splitting image.","default":"(3,3)"}]',
    category: 0
  },
  {
    id: 40,
  ...
  },
  {
    id: 50,
    name: 'ToGray',
    description: 'Convert the input RGB image to grayscale. If the mean pixel value for the resulting image is greater than 127, invert the resulting grayscale image.',
    parameters: '[{"name":"p","type":"float","description":"probability of applying the transform. ","default":0.5}]',
    category: 0
  },
  {
    ...
    parameters: '[{"name":"p","type":"float","description":"probability of applying the transform. Default: 0.5.","default":0.5}]',
    category: 0
  },
  {
    id: 52,
  ...
  },
  {
    ...
    parameters: '[{"name":"height","type":"int","description":"height of the crop."},{"name":"width","type":"int","description":"width of the crop."},{"name":"p","type":"float","description":"probability of applying the transform. Default: 1.","default":1}]',
    category: 1
  },
  {
    id: 56,
    ...
    parameters: '[{"name":"x_min","type":"int","description":"Minimum upper left x coordinate.","default":0},{"name":"y_min","type":"int","description":"Minimum upper left y coordinate.","default":0},{"name":"x_max","type":"int","description":"Maximum lower right x coordinate.","default":1024},{"name":"y_max","type":"int","description":"Maximum lower right y coordinate.","default":1024}]',
    category: 1
  },
  {
    id: 57,
    name: 'CropAndPad',
    description: 'Crop and pad images by pixel amounts or fractions of image sizes. Cropping removes pixels at the sides (i.e. extracts a subimage from a given full image). Padding adds pixels to the sides (e.g. black pixels). This transformation will never crop images below a height or width of 1.',
  ...
  },
  {
    ...
    parameters: '[{"name":"max_part_shift","type":"float","description":"float value in (0.0, 1.0) range. Default 0.3","default":0.3},{"name":"p","type":"float","description":"probability of applying the transform. Default: 1.","default":1}]',
    category: 1
  },
  {
    id: 61,
  ...
  },
  {
    ...
    parameters: '[{"name":"max_size","type":"int","description":"maximum size of the image after the transformation.","default":1024},{"name":"interpolation","type":"OpenCV flag","description":"interpolation method. Default: cv2.INTER_LINEAR.","default":1},{"name":"p","type":"float","description":"probability of applying the transform. Default: 1.","default":1}]',
    category: 2
  },
  {
    id: 65,
  ...
  },
  {
    ...
    parameters: '[{"name":"height","type":"int","description":"desired height of the output."},{"name":"width","type":"int","description":"desired width of the output."},{"name":"interpolation","type":"OpenCV flag","description":"flag that is used to specify the interpolation algorithm. Should be one of: cv2.INTER_NEAREST, cv2.INTER_LINEAR, cv2.INTER_CUBIC, cv2.INTER_AREA, cv2.INTER_LANCZOS4. Default: cv2.INTER_LINEAR.","default":1},{"name":"p","type":"float","description":"probability of applying the transform. Default: 1.","default":1}]',
    category: 2
  },
  {
    id: 67,
    ...
    parameters: '[{"name":"max_size","type":"int","description":"maximum size of smallest side of the image after the transformation.","default":1024},{"name":"interpolation","type":"OpenCV flag","description":"interpolation method. Default: cv2.INTER_LINEAR.","default":1},{"name":"p","type":"float","description":"probability of applying the transform. Default: 1.","default":1}]',
    category: 2
  },
  {
    id: 68,
    ...
    parameters: '[{"name":"p","type":"float","description":"probability of applying the transform. ","default":0.5},{"name":"factor","type":"int","description":"number of times the input will be rotated by 90 degrees.","default":null}]',
    category: 3
  },
  {
    id: 69,
