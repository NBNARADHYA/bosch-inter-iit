...
class Balance:
    ...
    def oversampling(self):
        self.transform = A.Compose([
            ...
            A.CLAHE(always_apply=False, p=0.5, clip_limit=(
                1, 4), tile_grid_size=(8, 8)),
            A.GaussNoise(always_apply=False, p=0.4, var_limit=(20, 40)),
            A.Downscale(always_apply=False, p=0.4, scale_min=0.5,
                        scale_max=0.8, interpolation=0),
            A.HueSaturationValue(always_apply=False, p=0.4, hue_shift_limit=(-20, 20),
    ...
    def balance(self):
        ...
        for x in range(len(class_ids)):
            ...
            for i in range(self.min_samples - len(images)):
                ...
                pathimg = path + 'newsample_' + \
                    str(id)+str(i) + imagepath[-4:]
